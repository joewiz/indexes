...
(: 
 ...
 : templating.
 :)
import module namespace config="http://exist-db.org/apps/indexes/config" at "config.xqm";
import module namespace app="http://exist-db.org/apps/indexes/templates" at "app.xql";
