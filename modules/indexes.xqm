        ...
        <div>
            ...
            <form method="get" class="form-horizontal" action="{indexes:remove-parameter-names('start-value')}">
                <div class="control-group">
                    <label class="control-label" for="max">Max number returned:</label>
                    <div class="controls">
                ...
                <div class="control-group">
                    <label class="control-label" for="start-value">Find terms starting with:</label>
                    <div class="controls">
                        <input id="start-value" name="start-value" type="text" class="input-medium search-query" value="{$indexes:start-value}"/>
                        ...
                        <button type="submit" class="btn" style="display:block; margin-top: 1em">Submit</button>
                    </div>
                </div>
            </form>
            <table class="table table-bordered">
